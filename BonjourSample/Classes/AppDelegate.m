...
@synthesize window, viewController, servicesArray;
...
- (BOOL)application:(UIApplication*)application didFinishLaunchingWithOptions:(NSDictionary*)launchOptions
{
    ...
    if (url && [url isKindOfClass:[NSURL class]]) {
        ...
        NSLog(@"BonjourSample launchOptions = %@", url);
    }
...
// only valid if BonjourSample-Info.plist specifies a protocol to handle
